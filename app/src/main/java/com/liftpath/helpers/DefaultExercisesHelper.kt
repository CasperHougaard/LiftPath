...
object DefaultExercisesHelper {
    ...
    private val DEFAULT_EXERCISE_FULL_META: Map<Int, DefaultExerciseMeta> = mapOf(
        1   to DefaultExerciseMeta("deadlift",          Equipment.BARBELL,    null,                  Laterality.BILATERAL, R.drawable.ex_deadlift_barbell),
        2   to DefaultExerciseMeta("squat",             Equipment.BARBELL,    null,                  Laterality.BILATERAL, R.drawable.ex_back_squat_barbell),
        4   to DefaultExerciseMeta("biceps_curl",       Equipment.DUMBBELL,   null,                  Laterality.UNILATERAL, R.drawable.ex_biceps_curl_dumbbell),
        5   to DefaultExerciseMeta("triceps_extension", Equipment.CABLE,      null,                  Laterality.BILATERAL, R.drawable.ex_triceps_pushdown_cable),
        7   to DefaultExerciseMeta("chest_press",       Equipment.BARBELL,    ExerciseAngle.FLAT,    Laterality.BILATERAL, R.drawable.ex_bench_press_barbell),
        8   to DefaultExerciseMeta("split_squat",       Equipment.BARBELL,    null,                  Laterality.UNILATERAL, R.drawable.ex_split_squat_barbell),
        9   to DefaultExerciseMeta("calf_raise",        Equipment.MACHINE,    null,                  Laterality.BILATERAL, R.drawable.ex_calf_raise_machine),
        10  to DefaultExerciseMeta("decline_press",     Equipment.BARBELL,    ExerciseAngle.DECLINE, Laterality.BILATERAL, R.drawable.ex_decline_bench_press_barbell),
        11  to DefaultExerciseMeta("incline_press",     Equipment.DUMBBELL,   ExerciseAngle.INCLINE, Laterality.BILATERAL, R.drawable.ex_incline_dumbbell_press),
        12  to DefaultExerciseMeta("row_horizontal",    Equipment.CABLE,      null,                  Laterality.BILATERAL, R.drawable.ex_seated_cable_row),
        13  to DefaultExerciseMeta("triceps_extension", Equipment.CABLE,      null,                  Laterality.UNILATERAL, R.drawable.ex_triceps_extension_single_arm),
        14  to DefaultExerciseMeta("overhead_press",    Equipment.MACHINE,    null,                  Laterality.BILATERAL, R.drawable.ex_machine_shoulder_press),
        15  to DefaultExerciseMeta("dips",              Equipment.BODYWEIGHT, null,                  Laterality.BILATERAL, R.drawable.ex_dips_bodyweight),
        16  to DefaultExerciseMeta("ab_crunch",         Equipment.MACHINE,    null,                  Laterality.BILATERAL, R.drawable.ex_abdominal_crunch_machine),
        17  to DefaultExerciseMeta("chest_press",       Equipment.BARBELL,    ExerciseAngle.FLAT,    Laterality.BILATERAL, R.drawable.ex_bench_press_paused),
        18  to DefaultExerciseMeta("leg_curl",          Equipment.MACHINE,    null,                  Laterality.BILATERAL, R.drawable.ex_seated_leg_curl_machine),
        100 to DefaultExerciseMeta("overhead_press",    Equipment.BARBELL,    null,                  Laterality.BILATERAL, R.drawable.ex_overhead_press_barbell),
        101 to DefaultExerciseMeta("pull_up",           Equipment.BODYWEIGHT, null,                  Laterality.BILATERAL, R.drawable.ex_pull_up),
        102 to DefaultExerciseMeta("pull_up",           Equipment.BODYWEIGHT, null,                  Laterality.BILATERAL, R.drawable.ex_chin_up),
        103 to DefaultExerciseMeta("rdl",               Equipment.BARBELL,    null,                  Laterality.BILATERAL, R.drawable.ex_romanian_deadlift_barbell),
        104 to DefaultExerciseMeta("leg_press",         Equipment.MACHINE,    null,                  Laterality.BILATERAL, R.drawable.ex_leg_press),
        105 to DefaultExerciseMeta("split_squat",       Equipment.DUMBBELL,   null,                  Laterality.UNILATERAL, R.drawable.ex_bulgarian_split_squat_dumbbell),
        106 to DefaultExerciseMeta("lat_pulldown",      Equipment.CABLE,      null,                  Laterality.BILATERAL, R.drawable.ex_lat_pulldown_wide_grip),
        107 to DefaultExerciseMeta("row_horizontal",    Equipment.DUMBBELL,   null,                  Laterality.UNILATERAL, R.drawable.ex_dumbbell_row),
        108 to DefaultExerciseMeta("face_pull",         Equipment.CABLE,      null,                  Laterality.BILATERAL, R.drawable.ex_face_pull_cable),
        109 to DefaultExerciseMeta("lateral_raise",     Equipment.DUMBBELL,   null,                  Laterality.BILATERAL, R.drawable.ex_lateral_raise_dumbbell),
        110 to DefaultExerciseMeta("leg_extension",     Equipment.MACHINE,    null,                  Laterality.BILATERAL, R.drawable.ex_leg_extension_machine),
        111 to DefaultExerciseMeta("hip_thrust",        Equipment.BARBELL,    null,                  Laterality.BILATERAL, R.drawable.ex_hip_thrust_barbell),
        112 to DefaultExerciseMeta("triceps_extension", Equipment.EZ_BAR,     ExerciseAngle.FLAT,    Laterality.BILATERAL, R.drawable.ex_skullcrusher_ez_bar),
        113 to DefaultExerciseMeta("biceps_curl",       Equipment.DUMBBELL,   null,                  Laterality.BILATERAL, R.drawable.ex_hammer_curl_dumbbell),
        114 to DefaultExerciseMeta("squat",             Equipment.BARBELL,    null,                  Laterality.BILATERAL, R.drawable.ex_front_squat_barbell),
        115 to DefaultExerciseMeta("split_squat",       Equipment.BODYWEIGHT, null,                  Laterality.UNILATERAL, R.drawable.ex_walking_lunges),
        116 to DefaultExerciseMeta("chest_fly",         Equipment.DUMBBELL,   ExerciseAngle.INCLINE, Laterality.BILATERAL, R.drawable.ex_incline_dumbbell_fly),
        117 to DefaultExerciseMeta("chest_fly",         Equipment.MACHINE,    null,                  Laterality.BILATERAL, R.drawable.ex_pec_deck_machine_fly),
        118 to DefaultExerciseMeta("overhead_press",    Equipment.DUMBBELL,   null,                  Laterality.BILATERAL, R.drawable.ex_dumbbell_shoulder_press_seated),
        119 to DefaultExerciseMeta("reverse_fly",       Equipment.DUMBBELL,   null,                  Laterality.BILATERAL, R.drawable.ex_reverse_fly_dumbbell),
        120 to DefaultExerciseMeta("ab_crunch",         Equipment.BODYWEIGHT, null,                  Laterality.BILATERAL, R.drawable.ex_hanging_leg_raise),
        121 to DefaultExerciseMeta("plank",             Equipment.BODYWEIGHT, null,                  Laterality.BILATERAL, R.drawable.ex_plank),
        122 to DefaultExerciseMeta("cable_woodchopper", Equipment.CABLE,      null,                  Laterality.UNILATERAL, R.drawable.ex_cable_woodchopper),
        123 to DefaultExerciseMeta("deadlift",          Equipment.BARBELL,    null,                  Laterality.BILATERAL, R.drawable.ex_sumo_deadlift),
        124 to DefaultExerciseMeta("shrug",             Equipment.BARBELL,    null,                  Laterality.BILATERAL, R.drawable.ex_barbell_shrug),
        125 to DefaultExerciseMeta("farmers_walk",      Equipment.OTHER,      null,                  Laterality.BILATERAL, R.drawable.ex_farmers_walk),
        126 to DefaultExerciseMeta("hip_thrust",        Equipment.BARBELL,    null,                  Laterality.BILATERAL, R.drawable.ex_glute_bridge_barbell),
        127 to DefaultExerciseMeta("squat",             Equipment.KETTLEBELL, null,                  Laterality.BILATERAL, R.drawable.ex_goblet_squat),
        128 to DefaultExerciseMeta("row_horizontal",    Equipment.BARBELL,    null,                  Laterality.BILATERAL, R.drawable.ex_barbell_row_pendlay),
        129 to DefaultExerciseMeta("chest_fly",         Equipment.CABLE,      null,                  Laterality.BILATERAL, R.drawable.ex_cable_crossover),
        130 to DefaultExerciseMeta("biceps_curl",       Equipment.EZ_BAR,     null,                  Laterality.BILATERAL, R.drawable.ex_preacher_curl_ez_bar),
        131 to DefaultExerciseMeta("chest_press",       Equipment.BODYWEIGHT, ExerciseAngle.FLAT,    Laterality.BILATERAL, R.drawable.ex_push_up),
        132 to DefaultExerciseMeta("rotary_torso",      Equipment.MACHINE,    null,                  Laterality.BILATERAL, R.drawable.ex_rotary_torso_machine),
        133 to DefaultExerciseMeta("incline_press",     Equipment.MACHINE,    ExerciseAngle.INCLINE, Laterality.BILATERAL, R.drawable.ex_incline_press_machine),
        134 to DefaultExerciseMeta("hip_adduction",     Equipment.MACHINE,    null,                  Laterality.BILATERAL, R.drawable.ex_hip_adduction),
        135 to DefaultExerciseMeta("hip_abduction",     Equipment.MACHINE,    null,                  Laterality.BILATERAL, R.drawable.ex_hip_abduction),
        136 to DefaultExerciseMeta("rdl",               Equipment.DUMBBELL,   null,                  Laterality.BILATERAL, R.drawable.ex_romanian_deadlift_dumbbell),
        137 to DefaultExerciseMeta("plank",             Equipment.BODYWEIGHT, null,                  Laterality.UNILATERAL, R.drawable.ex_side_plank),
        138 to DefaultExerciseMeta("calf_raise",        Equipment.BODYWEIGHT, null,                  Laterality.BILATERAL, R.drawable.ex_eccentric_heel_drop),
        139 to DefaultExerciseMeta("chest_press",       Equipment.MACHINE,    null,                  Laterality.BILATERAL, R.drawable.ex_chest_press_machine_wide),
        140 to DefaultExerciseMeta("chest_press",       Equipment.MACHINE,    null,                  Laterality.BILATERAL, R.drawable.ex_chest_press_machine),
        141 to DefaultExerciseMeta("row_horizontal",    Equipment.MACHINE,    null,                  Laterality.BILATERAL, R.drawable.ex_row_machine),
        142 to DefaultExerciseMeta("leg_curl",          Equipment.MACHINE,    null,                  Laterality.BILATERAL, R.drawable.ex_prone_leg_curl),
        143 to DefaultExerciseMeta("lateral_raise",     Equipment.CABLE,      null,                  Laterality.UNILATERAL, R.drawable.ex_cable_lateral_raise),
        144 to DefaultExerciseMeta("incline_press",     Equipment.BARBELL,    ExerciseAngle.INCLINE, Laterality.BILATERAL, R.drawable.ex_incline_barbell_press),
        145 to DefaultExerciseMeta("glute_machine",     Equipment.MACHINE,    null,                  Laterality.UNILATERAL, R.drawable.ex_glute_machine),
        146 to DefaultExerciseMeta("squat",             Equipment.MACHINE,    null,                  Laterality.BILATERAL, R.drawable.ex_hack_squat),
        147 to DefaultExerciseMeta("cable_leg_raises",  Equipment.CABLE,      null,                  Laterality.UNILATERAL, R.drawable.ex_cable_straight_leg_raises),
        148 to DefaultExerciseMeta("glute_machine",     Equipment.CABLE,      null,                  Laterality.UNILATERAL, R.drawable.ex_cable_straight_back_kicks),
        149 to DefaultExerciseMeta("row_horizontal",    Equipment.MACHINE,    null,                  Laterality.BILATERAL, R.drawable.ex_low_row_machine),
        150 to DefaultExerciseMeta("front_raise",       Equipment.DUMBBELL,   null,                  Laterality.BILATERAL, R.drawable.ex_front_raise_dumbbell),
        151 to DefaultExerciseMeta("front_raise",       Equipment.CABLE,      null,                  Laterality.BILATERAL, R.drawable.ex_front_raise_cable),
        152 to DefaultExerciseMeta("upright_row",       Equipment.BARBELL,    null,                  Laterality.BILATERAL, R.drawable.ex_upright_row_barbell),
        153 to DefaultExerciseMeta("back_extension",    Equipment.MACHINE,    null,                  Laterality.BILATERAL, R.drawable.ex_back_extension_machine),
        154 to DefaultExerciseMeta("back_extension",    Equipment.BODYWEIGHT, null,                  Laterality.BILATERAL, R.drawable.ex_hyperextension_45),
        155 to DefaultExerciseMeta("good_morning",      Equipment.BARBELL,    null,                  Laterality.BILATERAL, R.drawable.ex_good_morning_barbell),
        156 to DefaultExerciseMeta("ab_wheel",          Equipment.OTHER,      null,                  Laterality.BILATERAL, R.drawable.ex_ab_wheel_rollout),
        157 to DefaultExerciseMeta("kettlebell_swing",  Equipment.KETTLEBELL, null,                  Laterality.BILATERAL, R.drawable.ex_kettlebell_swing),
        158 to DefaultExerciseMeta("close_grip_bench",  Equipment.BARBELL,    ExerciseAngle.FLAT,    Laterality.BILATERAL, R.drawable.ex_close_grip_bench_press),
        159 to DefaultExerciseMeta("calf_raise",        Equipment.MACHINE,    null,                  Laterality.BILATERAL, R.drawable.ex_seated_calf_raise_machine),
        160 to DefaultExerciseMeta("leg_curl",          Equipment.BODYWEIGHT, null,                  Laterality.BILATERAL, R.drawable.ex_nordic_curl),
        161 to DefaultExerciseMeta("split_squat",       Equipment.DUMBBELL,   null,                  Laterality.UNILATERAL, R.drawable.ex_step_up_dumbbell),
        162 to DefaultExerciseMeta("overhead_press",    Equipment.DUMBBELL,   null,                  Laterality.BILATERAL, R.drawable.ex_arnold_press_dumbbell),
        163 to DefaultExerciseMeta("deadlift",          Equipment.OTHER,      null,                  Laterality.BILATERAL, R.drawable.ex_trap_bar_deadlift),
